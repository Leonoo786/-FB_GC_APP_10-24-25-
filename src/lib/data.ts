...
export const vendors: Vendor[] = [
  { id: 'vendor-1', name: 'A-1 Electric', contactPerson: 'Sarah Connor', phone: '555-0101', email: 'sarah.c@a1electric.com', trade: 'Electrical' },
  { id: 'vendor-2', name: 'Allied Plumbing', contactPerson: 'John Smith', phone: '555-0102', email: 'john.s@alliedplumbing.com', trade: 'Plumbing' },
  { id: 'vendor-3', name: 'Structural Steel Inc.', contactPerson: 'Peter Parker', phone: '555-0103', email: 'p.parker@structuralsteel.com', trade: 'Steel' },
];
