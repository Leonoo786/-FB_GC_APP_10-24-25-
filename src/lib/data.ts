...
export const expenses: Expense[] = [
  ...
  { id: 'exp-49', projectId: 'proj-4', date: '2025-10-07', category: 'Parking lot', vendorName: 'The Kings Transport', description: 'Hauled off excess dirt and concrete wash concrete (to be reimburese)', amount: 4896.76, paymentMethod: "Karim's Card", paymentReference: "Karim's Card", invoiceNumber: 'Parking lot' },
